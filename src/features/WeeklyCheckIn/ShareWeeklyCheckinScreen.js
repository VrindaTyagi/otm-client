...
const ShareWeeklyCheckinScreen = ({
  ...
  return (
    <div ref={summaryRef} className=" flex h-full flex-col gap-2 bg-black">
            ...
            <p className=" flex flex-col gap-1 text-[10px] text-offwhite">
              ...
              Total weight lifted this week
              {
                <div className="flex items-center gap-1">
                  ...
                  <p className="font-sfpro text-[10px] text-white-opacity-50">
                    {weightLiftedComapre() > 0 ? 'more' : 'less'} than last week
                  </p>
                </div>
              }
            </p>
          ...
          {weeklyReport?.perfectWeek?.isPerfectWeek === true &&
            weeklyReport?.perfectWeek?.streak > 0 && (
              <div>
                ...
                <div className="mt-2 font-sfpro text-[12px] text-offwhite">
                  You Unlocked a perfect week badge this week.Keep crushing your
                  workout to maintain your streak.
                </div>
              </div>
            )}
                    ...
                    <div className="text-[10px] text-offwhite">
                      {(Number(weeklyReport?.energyLevelLastWeek) === 0 ||
                        ...
                        Number(weeklyReport?.energyLevelThisWeek) < 5 && (
                          <div className="font-sfpro text-[12px] text-offwhite">
                            You rated {weeklyReport?.energyLevelThisWeek} out of
                            5 on energy level. Let's aim for a higher score
                          </div>
                        )}
                      ...
                      {Number(weeklyReport?.energyLevelLastWeek) > 0 &&
                        Number(weeklyReport?.energyLevelLastWeek) >
                          ...
                          <div className="font-sfpro text-[12px] text-offwhite">
                            You have rated a lower score than last week. Let's
                      ...
                      {Number(weeklyReport?.energyLevelLastWeek) > 0 &&
                        Number(weeklyReport?.energyLevelLastWeek) <
                          Number(weeklyReport?.energyLevelThisWeek) && (
                          <div className="font-sfpro text-[12px] text-offwhite">
                            You have rated a higher score than last week.Keep
                            Going!
                          </div>
                        )}
                      {Number(weeklyReport?.energyLevelLastWeek) ===
              ...
              <div className=" flex w-1/2 grow  flex-col rounded-lg bg-white-opacity-08 px-[16px] py-[9px]">
                ...
                <div className="mt-2 flex gap-3">
                  ...
                  {(Number(weeklyReport?.stressLevelsLastWeek) === 0 ||
                    ...
                    Number(weeklyReport?.stressLevelsThisWeek) > 1 && (
                      <div className="font-sfpro text-[12px] text-offwhite">
                        You rated {weeklyReport?.stressLevelsThisWeek} out of 5
                        on stress level. Let's aim for a lower score
                      </div>
                    )}
                  {(Number(weeklyReport?.stressLevelsLastWeek) === 0 ||
                    !Number(weeklyReport?.stressLevelsLastWeek)) &&
                    Number(weeklyReport?.stressLevelsThisWeek) === 1 && (
                      <div className="font-sfpro text-[12px] text-offwhite">
                        You rated {weeklyReport?.stressLevelsThisWeek} out of 5
                        on stress level. Keep going
                      </div>
                    )}
                  {Number(weeklyReport?.stressLevelsLastWeek) >
                    Number(weeklyReport?.stressLevelsThisWeek) && (
                    <div className="font-sfpro text-[12px] text-offwhite">
                      You have rated a higher score than last week. Let's aim
                      for lower score
                    </div>
                  )}
                  {Number(weeklyReport?.stressLevelsLastWeek) !== 0 &&
                  ...
                  <div className="mt-2 flex gap-3">
                    ...
                    <div className="text-[10px] text-offwhite">
                      {(Number(weeklyReport?.sleepQualityLastWeek) === 0 ||
                        ...
                        Number(weeklyReport?.sleepQualityThisWeek) < 5 && (
                          <div className="font-sfpro text-[12px] text-offwhite">
                            You rated {weeklyReport?.sleepQualityThisWeek} out
                            of 5 on sleep level. Let's aim for a higher score
                          </div>
                        )}
                      {(Number(weeklyReport?.sleepQualityLastWeek) === 0 ||
                        !Number(weeklyReport?.sleepQualityLastWeek)) &&
                        Number(weeklyReport?.sleepQualityThisWeek) === 5 && (
                          <div className="font-sfpro text-[12px] text-offwhite">
                            You rated {weeklyReport?.sleepQualityThisWeek} out
                            of 5 on sleep level. Keep going
                          </div>
                        )}
                      {Number(weeklyReport?.sleepQualityLastWeek) > 0 &&
                        Number(weeklyReport?.sleepQualityLastWeek) >
                ...
                <div className="mt-2 flex gap-3">
                  ...
                  <div className="text-[10px] text-offwhite">
                    {(Number(weeklyReport?.nutritionRatingLastWeek) === 0 ||
                      ...
                      Number(weeklyReport?.nutritionRatingThisWeek) < 5 && (
                        <div className="font-sfpro text-[12px] text-offwhite">
                          You rated {weeklyReport?.nutritionRatingThisWeek} out
                          of 5 on nutrition level. Let's aim for a higher score
                        </div>
                      )}
                    ...
                    {(Number(weeklyReport?.nutritionRatingLastWeek) === 0 ||
                      ...
                      Number(weeklyReport?.nutritionRatingThisWeek) === 5 && (
                        <div className="font-sfpro text-[12px] text-offwhite">
                          You rated {weeklyReport?.nutritionRatingThisWeek} out
                          of 5 on nutrition level. Keep going
                        </div>
                      )}
                    {Number(weeklyReport?.nutritionRatingLastWeek) > 0 &&
                      Number(weeklyReport?.nutritionRatingLastWeek) >
                        ...
                        <div className="font-sfpro text-[12px] text-offwhite">
                          You have rated a lower score than last week. Let's aim
                          for higher score
                        </div>
                      )}
                    {Number(weeklyReport?.nutritionRatingLastWeek) > 0 &&
      ...
      {weeklyReport?.last8WeekWeightHistory.length > 0 && (
        <div className=" flex flex-col  rounded-lg bg-white-opacity-08 px-[16px] py-[9px]">
          <div className="flex items-center justify-between gap-3">
            ...
            <p className="text-[10px] text-white-opacity-50">last 8 weeks</p>
          </div>
